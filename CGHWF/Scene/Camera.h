...
struct AABB {
	glm::vec3 minBounds; // 最小边界
	glm::vec3 maxBounds; // 最大边界
...
public:
	...
	AABB(glm::vec3(-20.0f, 0.0f, 69.5f), glm::vec3(70.0f, 20.0f, 70.5f)), // 左侧墙体
	AABB(glm::vec3(69.5f, 0.0f, -20.0f), glm::vec3(70.5f, 20.0f, 70.0f)), // 前侧墙体
	AABB(glm::vec3(-20.5f, 0.0f, -20.0f), glm::vec3(-19.5f, 20.0f, 70.0f)), // 后侧墙体
	AABB(glm::vec3(-20.0f, 0.0f, -20.5f), glm::vec3(70.0f, 20.0f, -19.5f))  // 右侧墙体
	};
